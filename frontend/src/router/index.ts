...
const routes = [
  ...
  { path: '/foods', name: 'Foods', meta: { requiresAuth: false }, component: () => import('@/views/food/FoodSearchView.vue') },
  { path: '/foods/:id', name: 'FoodDetail', meta: { requiresAuth: false }, component: () => import('@/views/food/FoodDetailView.vue') },
